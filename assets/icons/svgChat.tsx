...
export const ChatSvg:FC<IProps>= ({width,height,color}) => (
    <Svg
    width={width || 36}
    height={height || 36}
  ...
  >
    ...
    fill={color || '#fff'} />
    <Path d="M512 499.2a51.2 51.2 0 1 1 0-102.4 51.2 51.2 0 0 1 0 102.4zm192 0a51.2 51.2 0 1 1 0-102.4 51.2 51.2 0 0 1 0 102.4zm-384 0a51.2 51.2 0 1 1 0-102.4 51.2 51.2 0 0 1 0 102.4z" 
    fill={color || '#fff'} />
  </Svg>
);